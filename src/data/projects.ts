...
export const projects: Project[] = [
  ...
  // ============= أنظمة تعليمية =============
  {
    ...
    titleAr: 'نظام إدارة المدارس والمؤسسات التعليمية',
    category: 'Odoo Enterprise',
    ...
    stats: [
      ...
      { icon: 'check', value: '100%', label: 'مرونة التشغيل' },
      { icon: 'star', value: '3M Code', label: 'المطور' },
    ],
    technologies: [
      { name: 'Python', description: 'لغة البرمجة الأساسية لتطوير الموديولات', percentage: 95 },
      { name: 'Odoo 19', description: 'إطار العمل الرئيسي للنظام', percentage: 98 },
      { name: 'PostgreSQL', description: 'قاعدة البيانات المركزية', percentage: 90 },
      { name: 'XML/QWeb', description: 'تصميم الواجهات والتقارير', percentage: 92 },
      { name: 'JavaScript/OWL', description: 'تطوير الواجهات التفاعلية', percentage: 85 },
      { name: 'mail.thread', description: 'نظام التواصل الحي (Chatter)', percentage: 88 },
    ],
    features: [
      'النظام الأساسي (School Core) - القلب النابض بالإعدادات والجداول المرجعية',
      'النظام الأكاديمي (School Academic) - السنوات الدراسية والمراحل والصفوف والمواد',
      'إدارة شؤون الطلاب (School Student) - ملفات إلكترونية شاملة لكل طالب',
      'إدارة أولياء الأمور (School Parent) - ربط العائلات وقنوات التواصل',
      'إدارة الجداول الدراسية (School Timetable) - تخطيط الحصص بذكاء بدون تضارب',
      'نظام الحضور والغياب (School Attendance) - رصد فوري مع معدلات الحضور',
      'الإدارة المالية (School Fees) - هياكل رسوم وفواتير وتتبع الدفع',
      'إدارة الدرجات (School Grades) - حساب تلقائي للنسب والتقديرات وإصدار الشهادات',
    ],
    supabaseFeatures: [
      { name: 'School Core', nameAr: 'النظام الأساسي المركزي' },
      { name: 'School Academic', nameAr: 'النظام الأكاديمي الشامل' },
      { name: 'School Student', nameAr: 'إدارة شؤون الطلاب' },
      { name: 'School Parent', nameAr: 'إدارة أولياء الأمور' },
      { name: 'School Timetable', nameAr: 'إدارة الجداول الدراسية' },
      { name: 'School Attendance', nameAr: 'نظام الحضور والغياب' },
      { name: 'School Fees', nameAr: 'الإدارة المالية والرسوم' },
      { name: 'School Grades', nameAr: 'إدارة الدرجات والتقارير' },
    ],
    challenges: [
      'ضمان ترابط 8 وحدات مستقلة بسلاسة تامة',
      'التعامل مع هياكل رسوم مختلفة لكل مرحلة دراسية',
      'القضاء على تضارب الحصص في الجداول الدراسية',
      'ضمان دقة حساب الدرجات والتقديرات تلقائياً',
    ],
    solutions: [
      'بناء School Core كنواة مركزية تعتمد عليها جميع الوحدات',
      'نظام Fee Structures مرن يتكيف مع كل مرحلة',
      'خوارزمية ذكية لتوزيع الحصص بدون تعارض',
      'محرك حساب تلقائي مع تقديرات مرجعية قابلة للتخصيص',
    ],
    timeline: [
      { date: '2024 Q3', title: 'التصميم والتحليل', description: 'تحليل متطلبات المدارس وتصميم الهيكل', status: 'completed' },
      { date: '2024 Q4', title: 'تطوير النواة', description: 'بناء School Core و Academic و Student', status: 'completed' },
      { date: '2025 Q1', title: 'الوحدات المتقدمة', description: 'تطوير Timetable و Attendance و Fees و Grades', status: 'completed' },
      { date: '2025 Q2', title: 'النشر على Odoo Apps', description: 'اختبار شامل ونشر على متجر Odoo الرسمي', status: 'completed' },
    ],
  },
];
